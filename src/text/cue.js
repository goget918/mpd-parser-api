...
class Cue {
  ...
  constructor(startTime, endTime, payload) {
     ...
     * @export
     */
    this.positionAlign = this.positionAlign.AUTO;
     ...
     * @export
     */
    this.direction = this.direction.HORIZONTAL_LEFT_TO_RIGHT;
     ...
     * @export
     */
    this.writingMode = this.writingMode.HORIZONTAL_TOP_TO_BOTTOM;
     ...
     * @export
     */
    this.lineInterpretation = this.lineInterpretation.LINE_NUMBER;
     ...
     * @export
     */
    this.lineAlign = this.lineAlign.START;
     ...
     * @export
     */
    this.displayAlign = this.displayAlign.AFTER;
  ...
  static equal(cue1, cue2) {
    ...
    for (const k in cue1) {
      if (k == 'startTime' || k == 'endTime' || k == 'payload') {
        ...
        // This uses equal rather than just this.equal, since
...
class CueRegion {
  constructor() {
     ...
     * @export
     */
    this.heightUnits = units.PERCENTAGE;
     ...
     * @export
     */
    this.widthUnits = units.PERCENTAGE;
     ...
     * @export
     */
    this.viewportAnchorUnits = units.PERCENTAGE;
     ...
     * @export
     */
    this.scroll = scrollMode.NONE;
  }
};

module.exports = { Cue, CueRegion };