...
class SegmentReference {
  ...
  constructor(
    ...
    syncTime = null, status = SegmentReference.Status.AVAILABLE,
   ...
   */
  markAsUnavailable() {
    this.status = SegmentReference.Status.UNAVAILABLE;
  }
   ...
   *
   * @param {static ThumbnailSprite} thumbnailSprite
   * @export
   */
...
module.exports = { InitSegmentReference, SegmentReference };