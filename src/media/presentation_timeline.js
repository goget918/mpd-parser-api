...
class PresentationTimeline {
  ...
  setPresentationStartTime(presentationStartTime) {
    assert(presentationStartTime >= 0,
  ...
  setSegmentAvailabilityDuration(segmentAvailabilityDuration) {
    assert(segmentAvailabilityDuration >= 0,
  ...
  getSegmentAvailabilityStart() {
    assert(this.segmentAvailabilityDuration_ >= 0,
   ...
   */
  getLiveEdge_() {
    assert(this.presentationStartTime_ != null,
...
module.exports = PresentationTimeline;
